/*
Display Activity that shows a list of different stock to select to navigate to display detail pages.
The display activity uses the newest recycler view component.
 */
...
public class DisplayActivity extends AppCompatActivity implements MarketsAdapter.MarketAdapterOnClickHandler {
    ...
    /*
    method to download data from yahoo finance api
     */
    ...
    /*
    method to create refresh button on the menu
     */
    @Override
    ...
    /*
    method to refresh and load the data
     */
    @Override
