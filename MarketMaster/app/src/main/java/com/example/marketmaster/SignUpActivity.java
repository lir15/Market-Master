/*
Sign up activity that contains several input area to get the basic information from the users to
establish an account for them to login. The users can navigate from the sign up page to the login
page after they successfully register for the application.
 */
...
public class SignUpActivity extends AppCompatActivity {
    ...
    /*
    method to insert the users input to the database
     */
...
//old version of sign up activity
