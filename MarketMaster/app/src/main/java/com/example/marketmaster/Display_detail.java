/*
Display detail activity which shows the chart of the stock trends using an external library.
With the help of the library, we can make a chart based on the stock data returned from the
yahoo finance api
 */
...
public class Display_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Show toast if the insert is successful
                if (insert) {
                    Toast.makeText(Display_detail.this, "Successfully added!", Toast.LENGTH_LONG).show();
                } else {
    ...
    public boolean insertdata(String fname) {
        ...
        cursor1 = watchDB.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE Name = ?", new String[]{fname});
    ...
    /*
    method to pop out the display window
     */
